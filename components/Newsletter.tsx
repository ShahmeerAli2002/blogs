      ...
      <div className="mx-auto max-w-screen-md sm:text-center">
        ...
        <form action="#">
          ...
          <div className="mx-auto max-w-screen-sm text-sm text-left text-gray-500 newsletter-form-footer dark:text-gray-600">
            We care about the protection of your data. <Link href="#" className="font-medium text-primary-600 dark:text-primary-500 hover:underline">Read our Privacy Policy</Link>.
          </div>
        </form>
        ...
        <div className="mt-12">
          ...
          <form onSubmit={handleCommentSubmit} className="mb-4">
            <textarea
              className="w-full p-3 text-sm border rounded-lg focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white dark:border-gray-600 dark:focus:ring-primary-500 dark:focus:border-primary-500"
              placeholder="Add a comment..."
              value={newComment}
              onChange={(e) => setNewComment(e.target.value)}
              required
            />
            <button type="submit" className="mt-2 py-2 px-4 text-sm font-medium text-center rounded-lg bg-black text-white hover:bg-gray-800">Submit Comment</button>
          </form>
